"""Health use cases for the worker service."""

import logging
from collections.abc import Sequence

from docmind_worker.application.health.ports import HealthProbe
from docmind_worker.domain.health.models import HealthCheckResult, HealthReport, HealthStatus
from docmind_worker.domain.health.policies import aggregate_health_status
...
class HealthService:
    ...
    async def get_readiness(self) -> HealthReport:
        """Return readiness for accepting worker admin traffic."""
