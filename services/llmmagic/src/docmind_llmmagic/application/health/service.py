"""Health use cases for the LLM Magic service."""

import logging
from collections.abc import Sequence

from docmind_llmmagic.application.health.ports import HealthProbe
from docmind_llmmagic.domain.health.models import HealthCheckResult, HealthReport, HealthStatus
from docmind_llmmagic.domain.health.policies import aggregate_health_status
